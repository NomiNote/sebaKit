// AlertOverlay — dismissable modal popup that shows when the ESP32 triggers an alert.
// Renders over any page. Auto-dismisses when Supabase Realtime reports status change.
